    ...
    <?php if (!empty($_GET['logout'])){
            if ($_GET['logout']=='success' and !empty($_SESSION['outlog'])){ ?>
                ...
                $(document).ready(function () {
                    swal.fire({ title: "Logout Successful!", text: "You are already logout!",imageUrl: '<?php echo asset_url()?>/media/logos/lock.gif',imageWidth: 300,imageHeight: 200,showConfirmButton: false, timer:1100 });
                });
                </script>
        <?php }
        }?>
